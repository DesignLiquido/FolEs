...
export const MetodoRotacionarMatiz: Array<string> = [
    'filtro-fundo',
];
...
export const MetodosInclinar: Array<string> = [
    'transformar',
];

export const MetodosTranslacao: Array<string> = [
    'transformar',
];
...
export const MetodosFolEs: Array<string> = [
    'borrar',
    'brilho',
    'calcular',
    'contraste',
