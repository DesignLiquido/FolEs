...
export class LarguraFimBordaEmLinha extends Modificador {
    ...
    constructor(valor: string, quantificador?: string) {
        ...
        if (Number.isNaN(parseInt(valor)) &&
            ...
            throw new Error(
                `Propriedade 'largura-fim-borda-em-linha' com valor ${valor} inválido. O valor deve ser numérico ou um dos valores:
        ...
        if (Number(parseInt(valor))) {
            if (
                ...
                throw new Error(
                    `Propriedade 'largura-fim-borda-em-linha' com quantificador inválido. Valores aceitos:
