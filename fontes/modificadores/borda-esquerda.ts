...
export class BordaEsquerda extends Modificador {
    ...
    constructor(valor: string, quantificador?: string, pragmas?: PragmasModificador) {
        ...
        if (!(valor in this.valoresAceitos) &&
            ...
            throw new Error(`Propriedade 'borda-esquerda' com valor ${valor} inválido. Valores aceitos: 
        ...
        if (Number(parseInt(valor))) {
            if (!(quantificador in unidadesMedida) || quantificador === undefined) {
                throw new Error(`Propriedade 'borda-esquerda' com quantificador inválido. Valores aceitos:
