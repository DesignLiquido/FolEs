...
export class AlturaMinima extends Modificador {
    ...
    constructor(valor: string, quantificador?: string) {
        ...
        if (Number.isNaN(parseInt(valor)) &&
            ...
            throw new Error(
                `Propriedade 'altura-mínima' com valor ${valor} inválido. O valor deve ser numérico ou um dos valores:
        ...
        if (Number(parseInt(valor))) {
            if (
                ...
                throw new Error(
                    `Propriedade 'altura-mínima' com quantificador inválido. Valores aceitos:
