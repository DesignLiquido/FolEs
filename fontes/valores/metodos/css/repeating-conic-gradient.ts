...
export class RepeatingConicGradient extends MetodoCss {
    ...
    constructor(
        cor1: Simbolo, valor1: Simbolo, quantificador1: Simbolo, valor2?: Simbolo, quantificador2?: Simbolo,
        cor2?: Simbolo, valor3?: Simbolo, quantificador3?: Simbolo, valor4?: Simbolo, quantificador4?: Simbolo,
        cor3?: Simbolo, valor5?: Simbolo, quantificador5?: Simbolo, valor6?: Simbolo, quantificador6?: Simbolo,
    ) {
        super();
        ...
        this.cor2 = cor2 ? cor2.lexema : null;
        ...
        this.cor3 = cor3 ? cor3.lexema : null;
        ...
        this.arrayValores.push(
            this.cor1, this.valor1, this.quantificador1, this.valor2, this.quantificador2,
            this.cor2, this.valor3, this.quantificador3, this.valor4, this.quantificador4,
            this.cor3, this.valor5, this.quantificador5, this.valor6, this.quantificador6,
        );
    ...
    paraTexto() {
        ...
        this.arrayValores.forEach((valorIndividual, index) => {
            ...
            const indicesComVirgula: Array<number> = [4, 9];
            if (valorIndividual) {
                if (typeof valorIndividual === 'number') {
                    traducaoRetorno += ` ${valorIndividual}`;
                } else {
                    const coresCss: Array<string> = Object.values(cores);
                    if (coresCss.includes(valorIndividual)) {
                        const corFolEs: string = Object.keys(cores).find(chave => cores[chave] === valorIndividual);
                        if (index === 0) {
