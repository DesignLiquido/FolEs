...
export const AtribuicaoAbreviadaPREspecificas: TraducaoValoresMetodoInterface[] = [
    ...
    },
    {
        modificador: 'fonte',
        css: 'font',
        valor: 'italica muito-pequeno em-negrito',
        traducao: 'italic x-small bold',
    },
    {
        modificador: 'fundo',
        css: 'background',
        valor: 'borda-caixa repetir vermelho',
    ...
    },
    {
        ...
        css: 'font-synthesis',
        valor: 'maiúsculas-pequenas itálica',
...
borda (3)
borda-em-bloco (3)
fim-borda-em-bloco (3)
inicio-borda-em-bloco (3)
borda-inferior (3)
cor-borda (4)
borda-em-linha (3)
fim-borda-em-linha (3)
inicio-borda-em-linha (3)
borda-esquerda (3)
borda-direita (3)
estilo-borda (4)
borda-superior (3)
