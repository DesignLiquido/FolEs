...
| [modo-máscara](https://github.com/DesignLiquido/FolEs/wiki/Modificador-modo-m%C3%A1scara)                            |	[mask-mode](https://developer.mozilla.org/en-US/docs/Web/CSS/mask-mode) |  
...
| nome-animacao                           |	[animation-name](https://developer.mozilla.org/en-US/docs/Web/CSS/animation-name) |
| nome-animação                           |	[animation-name](https://developer.mozilla.org/en-US/docs/Web/CSS/animation-name) |
...
| origem-imagem-borda	                  | [border-image-source](https://developer.mozilla.org/en-US/docs/Web/CSS/border-image-source) |
...
| [posicao-enfase-texto](https://github.com/DesignLiquido/FolEs/wiki/Modificador-posi%C3%A7%C3%A3o-%C3%AAnfase-texto)                    |	[text-emphasis-position](https://developer.mozilla.org/en-US/docs/Web/CSS/text-emphasis-position) |
...
| [proporcao-tela](https://github.com/DesignLiquido/FolEs/wiki/Modificador-propor%C3%A7%C3%A3o-tela)                          |	[aspect-ratio](https://developer.mozilla.org/en-US/docs/Web/CSS/aspect-ratio) |
...
| [quebrar-palavra](https://github.com/DesignLiquido/FolEs/wiki/Modificador-quebrar-palavra)                         |	[word-break](https://developer.mozilla.org/pt-BR/docs/Web/CSS/word-break) | 
| [raio-borda]([url](https://github.com/DesignLiquido/FolEs/wiki/Modificador-raio-borda))                              |    [border-radius](https://developer.mozilla.org/en-US/docs/Web/CSS/border-radius) | 
| [raio-direito-borda-inferior ](https://github.com/DesignLiquido/FolEs/wiki/Modificador-raio-direito-borda-inferior)            |	[border-bottom-right-radius](https://developer.mozilla.org/en-US/docs/Web/CSS/border-bottom-right-radius) |
| [raio-direito-borda-superior](https://github.com/DesignLiquido/FolEs/wiki/Modificador-raio-direito-borda-superior)             |	[border-top-right-radius](https://developer.mozilla.org/en-US/docs/Web/CSS/border-top-right-radius) |
| [raio-esquerdo-borda-inferior](https://github.com/DesignLiquido/FolEs/wiki/Modificador-raio-esquerdo-borda-inferior)            |	[border-bottom-left-radius](https://developer.mozilla.org/en-US/docs/Web/CSS/border-bottom-left-radius) |
| [raio-esquerdo-borda-superior](https://github.com/DesignLiquido/FolEs/wiki/Modificador-raio-esquerdo-borda-superior)            |	[border-top-left-radius](https://developer.mozilla.org/en-US/docs/Web/CSS/border-top-left-radius) |
| [recolher-borda](https://github.com/DesignLiquido/FolEs/wiki/Modificador-recolher-borda)                          |	[border-collapse](https://developer.mozilla.org/en-US/docs/Web/CSS/border-collapse) |
| [recortar](https://github.com/DesignLiquido/FolEs/wiki/Modificador-recortar)                                |	[clip](https://developer.mozilla.org/en-US/docs/Web/CSS/clip) |
| [recortar-fundo](https://github.com/DesignLiquido/FolEs/wiki/Modificador-recortar-fundo)                          |	[background-clip](https://developer.mozilla.org/pt-BR/docs/Web/CSS/background-clip) |
| [recortar-margem-vazada](https://github.com/DesignLiquido/FolEs/wiki/Modificador-recortar-margem-vazada)                  |	[overflow-clip-margin](https://developer.mozilla.org/en-US/docs/Web/CSS/overflow-clip-margin) |
| [recuo](https://github.com/DesignLiquido/FolEs/wiki/Modificador-recuo)                                   |	[padding](https://developer.mozilla.org/pt-BR/docs/Web/CSS/padding) |
| [recuo-direito](https://github.com/DesignLiquido/FolEs/wiki/Modificador-recuo-direito)                           |	[padding-right](https://developer.mozilla.org/en-US/docs/Web/CSS/padding-right) |
| [recuo-direito-rolagem-mouse](https://github.com/DesignLiquido/FolEs/wiki/Modificador-recuo-direito-rolagem-mouse)             |	[scroll-padding-right](https://developer.mozilla.org/en-US/docs/Web/CSS/scroll-padding-right) |
| [recuo-em-bloco](https://github.com/DesignLiquido/FolEs/wiki/Modificador-recuo-em-bloco)                          |	[padding-block](https://developer.mozilla.org/en-US/docs/Web/CSS/padding-block) |
| [recuo-em-bloco-fim](https://github.com/DesignLiquido/FolEs/wiki/Modificador-recuo-em-bloco-fim)                      |	[padding-block-end](https://developer.mozilla.org/en-US/docs/Web/CSS/padding-block) |
| [recuo-em-bloco-rolagem-mouse](https://github.com/DesignLiquido/FolEs/wiki/Modificador-recuo-em-bloco-rolagem-mouse)            |	[scroll-padding-block](https://developer.mozilla.org/en-US/docs/Web/CSS/scroll-padding-block) |
| [recuo-em-linha](https://github.com/DesignLiquido/FolEs/wiki/Modificador-recuo-em-linha)                          |	[padding-inline](https://developer.mozilla.org/en-US/docs/Web/CSS/padding-inline) |
| [recuo-em-linha-fim](https://github.com/DesignLiquido/FolEs/wiki/Modificador-recuo-em-linha-fim)                      |	[padding-inline-end](https://developer.mozilla.org/en-US/docs/Web/CSS/padding-inline-end) |
| [recuo-em-linha-rolagem-mouse](https://github.com/DesignLiquido/FolEs/wiki/Modificador-recuo-em-linha-rolagem-mouse)            |	[scroll-padding-inline](https://developer.mozilla.org/en-US/docs/Web/CSS/scroll-padding-inline) |
| [recuo-esquerdo](https://github.com/DesignLiquido/FolEs/wiki/Modificador-recuo-esquerdo)                          |	[padding-left](https://developer.mozilla.org/pt-BR/docs/Web/CSS/padding-left) |
| [recuo-esquerdo-rolagem-mouse](https://github.com/DesignLiquido/FolEs/wiki/Modificador-recuo-esquerdo-rolagem-mouse)            |	[scroll-padding-left](https://developer.mozilla.org/en-US/docs/Web/CSS/scroll-padding-left) |
| [recuo-inferior](https://github.com/DesignLiquido/FolEs/wiki/Modificador-recuo-inferior)                          |	[padding-bottom](https://developer.mozilla.org/en-US/docs/Web/CSS/padding-bottom) |
| [recuo-inferior-rolagem-mouse](https://github.com/DesignLiquido/FolEs/wiki/Modificador-recuo-inferior-rolagem-mouse)            |	[scroll-padding-bottom](https://developer.mozilla.org/en-US/docs/Web/CSS/scroll-padding-bottom) |
| [recuo-rolagem-mouse](https://github.com/DesignLiquido/FolEs/wiki/Modificador-recuo-rolagem-mouse)                     |	[scroll-padding](https://developer.mozilla.org/en-US/docs/Web/CSS/scroll-padding) |
| [recuo-superior](https://github.com/DesignLiquido/FolEs/wiki/Modificador-recuo-superior)                          |	[padding-top](https://developer.mozilla.org/en-US/docs/Web/CSS/padding-top) |
| [recuo-superior-rolagem-mouse](https://github.com/DesignLiquido/FolEs/wiki/Modificador-recuo-superior-rolagem-mouse)            |	[scroll-padding-top](https://developer.mozilla.org/en-US/docs/Web/CSS/scroll-padding-top) |
| [recursos-fonte](https://github.com/DesignLiquido/FolEs/wiki/Modificador-recursos%E2%80%90fonte)                          |	[font-feature-settings](https://developer.mozilla.org/pt-BR/docs/Web/CSS/font-feature-settings) |
| [redimensionar](https://github.com/DesignLiquido/FolEs/wiki/Modificador-redimensionar)                           |	[resize](https://developer.mozilla.org/en-US/docs/Web/CSS/resize) |
| [regras-coluna](https://github.com/DesignLiquido/FolEs/wiki/Modificador-regras-coluna)                           |	[column-rule](https://developer.mozilla.org/en-US/docs/Web/CSS/column-rule) |
| [regras-cor-coluna](https://github.com/DesignLiquido/FolEs/wiki/Modificador-regras-cor-coluna)                       |	[column-rule-color](https://developer.mozilla.org/en-US/docs/Web/CSS/column-rule-color) |
| [regras-estilo-coluna](https://github.com/DesignLiquido/FolEs/wiki/Modificador-regras-estilo-coluna)                    |	[column-rule-style](https://developer.mozilla.org/en-US/docs/Web/CSS/column-rule-style) |
| [regras-largura-coluna](https://github.com/DesignLiquido/FolEs/wiki/Modificador-regras-largura-coluna)                   |	[column-rule-width](https://developer.mozilla.org/en-US/docs/Web/CSS/column-rule-width) |
| [reiniciar-contador](https://github.com/DesignLiquido/FolEs/wiki/Modificador-reiniciar-contador)                      |	[counter-reset](https://developer.mozilla.org/en-US/docs/Web/CSS/counter-reset) |
| [reiniciar-tudo](https://github.com/DesignLiquido/FolEs/wiki/Modificador-reiniciar-tudo)                          |	[all](https://developer.mozilla.org/en-US/docs/Web/CSS/all) |
| [renderizacao-imagem](https://github.com/DesignLiquido/FolEs/wiki/Modificador-renderiza%C3%A7%C3%A3o-imagem)                     |	[image-rendering](https://developer.mozilla.org/en-US/docs/Web/CSS/image-rendering) |
| [renderização-imagem](https://github.com/DesignLiquido/FolEs/wiki/Modificador-renderiza%C3%A7%C3%A3o-imagem)                     |	[image-rendering](https://developer.mozilla.org/en-US/docs/Web/CSS/image-rendering) |
| [renderizacao-texto](https://github.com/DesignLiquido/FolEs/wiki/Modificador-renderiza%C3%A7%C3%A3o-texto)                      |	[text-rendering](https://developer.mozilla.org/pt-BR/docs/Web/CSS/text-rendering) |
| [renderização-texto](https://github.com/DesignLiquido/FolEs/wiki/Modificador-renderiza%C3%A7%C3%A3o-texto)                      |	[text-rendering](https://developer.mozilla.org/pt-BR/docs/Web/CSS/text-rendering) |
| [repeticao-borda-mascara](https://github.com/DesignLiquido/FolEs/wiki/Modificador-repeti%C3%A7%C3%A3o-borda-m%C3%A1scara)                 |	[mask-border-repeat](https://developer.mozilla.org/en-US/docs/Web/CSS/mask-border-repeat) |
| [repetição-borda-máscara](https://github.com/DesignLiquido/FolEs/wiki/Modificador-repeti%C3%A7%C3%A3o-borda-m%C3%A1scara)                 |	[mask-border-repeat](https://developer.mozilla.org/en-US/docs/Web/CSS/mask-border-repeat) |
| [repetir-animacao](https://github.com/DesignLiquido/FolEs/wiki/Modificador-repetir-anima%C3%A7%C3%A3o)                        |	[animation-iteration-count](https://developer.mozilla.org/en-US/docs/Web/CSS/animation-iteration-count) |
| [repetir-animação](https://github.com/DesignLiquido/FolEs/wiki/Modificador-repetir-anima%C3%A7%C3%A3o)                        |	[animation-iteration-count](https://developer.mozilla.org/en-US/docs/Web/CSS/animation-iteration-count) |
| [repetir-fundo](https://github.com/DesignLiquido/FolEs/wiki/Modificador-repetir-fundo)                           |	[background-repeat](https://developer.mozilla.org/en-US/docs/Web/CSS/background-repeat) |
| [repetir-imagem-borda](https://github.com/DesignLiquido/FolEs/wiki/Modificador-repetir-imagem-borda)                    |	[border-image-repeat](https://developer.mozilla.org/en-US/docs/Web/CSS/border-image-repeat) |        
| [repetir-mascara](https://github.com/DesignLiquido/FolEs/wiki/Modificador-repetir-m%C3%A1scara)                         |	[mask-repeat](https://developer.mozilla.org/en-US/docs/Web/CSS/mask-repeat) |
| [repetir-máscara](https://github.com/DesignLiquido/FolEs/wiki/Modificador-repetir-m%C3%A1scara)                         |	[mask-repeat](https://developer.mozilla.org/en-US/docs/Web/CSS/mask-repeat) |
| [rotacao-deslocamento](https://github.com/DesignLiquido/FolEs/wiki/Modificador-rota%C3%A7%C3%A3o-deslocamento)                    |	[offset-rotate](https://developer.mozilla.org/en-US/docs/Web/CSS/offset-rotate) |
| [rotação-deslocamento](https://github.com/DesignLiquido/FolEs/wiki/Modificador-rota%C3%A7%C3%A3o-deslocamento)                    |	[offset-rotate](https://developer.mozilla.org/en-US/docs/Web/CSS/offset-rotate) |
| [selecao-usuario](https://github.com/DesignLiquido/FolEs/wiki/Modificador-sele%C3%A7%C3%A3o-usu%C3%A1rio)                         |	[user-select](https://developer.mozilla.org/en-US/docs/Web/CSS/user-select) |
| [seleção-usuario](https://github.com/DesignLiquido/FolEs/wiki/Modificador-sele%C3%A7%C3%A3o-usu%C3%A1rio)                         |	[user-select](https://developer.mozilla.org/en-US/docs/Web/CSS/user-select) |
| [sintetizar-fonte](https://github.com/DesignLiquido/FolEs/wiki/Modificador-sintetizar-fonte)                        |	[font-synthesis](https://developer.mozilla.org/en-US/docs/Web/CSS/font-synthesis) |
| [sombra-caixa](https://github.com/DesignLiquido/FolEs/wiki/Modificador-sombra-caixa)                            |	[box-shadow](https://developer.mozilla.org/pt-BR/docs/Web/CSS/box-shadow) |
| [sombra-texto](https://github.com/DesignLiquido/FolEs/wiki/Modificador-sombra-texto)                            |	[text-shadow](https://developer.mozilla.org/pt-BR/docs/Web/CSS/text-shadow) |
| [status-animacao](https://github.com/DesignLiquido/FolEs/wiki/Modificador-status-anima%C3%A7%C3%A3o)                         |	[animation-play-state](https://developer.mozilla.org/en-US/docs/Web/CSS/animation-play-state) |
| [status-animação](https://github.com/DesignLiquido/FolEs/wiki/Modificador-status-anima%C3%A7%C3%A3o)                         |	[animation-play-state](https://developer.mozilla.org/en-US/docs/Web/CSS/animation-play-state) |
| [substituir-idioma-fonte](https://github.com/DesignLiquido/FolEs/wiki/Modificador-substituir-idioma-fonte)                 |	[font-language-override](https://developer.mozilla.org/en-US/docs/Web/CSS/font-language-override) |
| [tabulacao](https://github.com/DesignLiquido/FolEs/wiki/Modificador-tabula%C3%A7%C3%A3o)                               |	[tab-size](https://developer.mozilla.org/en-US/docs/Web/CSS/tab-size) |
| [tabulação](https://github.com/DesignLiquido/FolEs/wiki/Modificador-tabula%C3%A7%C3%A3o)                               |	[tab-size](https://developer.mozilla.org/en-US/docs/Web/CSS/tab-size) |
| [tamanho-caixa](https://github.com/DesignLiquido/FolEs/wiki/Modificador-tamanho-caixa)                           |	[box-sizing](https://developer.mozilla.org/pt-BR/docs/Web/CSS/box-sizing) |
| [tamanho-colunas-em-grade](https://github.com/DesignLiquido/FolEs/wiki/Modificador-tamanho-colunas-em-grade)                |	[grid-auto-columns](https://developer.mozilla.org/en-US/docs/Web/CSS/grid-auto-columns) |
| [tamanho-em-bloco](https://github.com/DesignLiquido/FolEs/wiki/Modificador-tamanho-em-bloco)                        |	[block-size](https://developer.mozilla.org/pt-BR/docs/Web/CSS/block-size) |
| [tamanho-em-linha](https://github.com/DesignLiquido/FolEs/wiki/Modificador-tamanho-em-linha)                        |	[inline-size](https://developer.mozilla.org/pt-BR/docs/Web/CSS/inline-size) |
| [tamanho-fonte](https://github.com/DesignLiquido/FolEs/wiki/Modificador-tamanho-fonte)                           |	[font-size](https://developer.mozilla.org/pt-BR/docs/Web/CSS/font-size) |
| [tamanho-fundo](https://github.com/DesignLiquido/FolEs/wiki/Modificador-tamanho-fundo)                           |	[background-size](https://developer.mozilla.org/pt-BR/docs/Web/CSS/background-size) |
| [tamanho-grade](https://github.com/DesignLiquido/FolEs/wiki/Modificador-tamanho-grade)                           |	[grid-area](https://developer.mozilla.org/en-US/docs/Web/CSS/grid-area) |
| [tamanho-linhas-em-grade](https://github.com/DesignLiquido/FolEs/wiki/Modificador-tamanho-linhas-em-grade)                 |	[grid-auto-rows](https://developer.mozilla.org/en-US/docs/Web/CSS/grid-auto-rows) |
| [tamanho-mascara](https://github.com/DesignLiquido/FolEs/wiki/Modificador-tamanho-m%C3%A1scara)                         |	[mask-size](https://developer.mozilla.org/en-US/docs/Web/CSS/mask-size) |
| [tamanho-máscara](https://github.com/DesignLiquido/FolEs/wiki/Modificador-tamanho-m%C3%A1scara)                         |	[mask-size](https://developer.mozilla.org/en-US/docs/Web/CSS/mask-size) |
| [tamanho-maximo-em-bloco](https://github.com/DesignLiquido/FolEs/wiki/Modificador-tamanho-m%C3%A1ximo-em-bloco)                 |	[max-block-size](https://developer.mozilla.org/en-US/docs/Web/CSS/max-block-size) |
| [tamanho-máximo-em-bloco](https://github.com/DesignLiquido/FolEs/wiki/Modificador-tamanho-m%C3%A1ximo-em-bloco)                 |	[max-block-size](https://developer.mozilla.org/en-US/docs/Web/CSS/max-block-size) |
| [tamanho-maximo-em-linha](https://github.com/DesignLiquido/FolEs/wiki/Modificador-tamanho-m%C3%A1ximo-em-linha)                 |	[max-inline-size](https://developer.mozilla.org/en-US/docs/Web/CSS/max-inline-size) |
| [tamanho-máximo-em-linha](https://github.com/DesignLiquido/FolEs/wiki/Modificador-tamanho-m%C3%A1ximo-em-linha)                 |	[max-inline-size](https://developer.mozilla.org/en-US/docs/Web/CSS/max-inline-size) |
| [tamanho-minimo-em-bloco](https://github.com/DesignLiquido/FolEs/wiki/Modificador-tamanho-m%C3%ADnimo-em-bloco)                 |	[min-block-size](https://developer.mozilla.org/en-US/docs/Web/CSS/min-block-size) |
| [tamanho-mínimo-em-bloco](https://github.com/DesignLiquido/FolEs/wiki/Modificador-tamanho-m%C3%ADnimo-em-bloco)                 |	[min-block-size](https://developer.mozilla.org/en-US/docs/Web/CSS/min-block-size) | 
| [tamanho-minimo-em-linha](https://github.com/DesignLiquido/FolEs/wiki/Modificador-tamanho-m%C3%ADnimo-em-linha)                 |	[min-inline-size](https://developer.mozilla.org/en-US/docs/Web/CSS/min-inline-size) |
| [tamanho-mínimo-em-linha](https://github.com/DesignLiquido/FolEs/wiki/Modificador-tamanho-m%C3%ADnimo-em-linha)                 |	[min-inline-size](https://developer.mozilla.org/en-US/docs/Web/CSS/min-inline-size) |
| [tamanho-optico-fonte](https://github.com/DesignLiquido/FolEs/wiki/Modificador-tamanho-%C3%B3ptico-fonte)                    |	[font-optical-sizing](https://developer.mozilla.org/en-US/docs/Web/CSS/font-optical-sizing) |
| [tamanho-óptico-fonte](https://github.com/DesignLiquido/FolEs/wiki/Modificador-tamanho-%C3%B3ptico-fonte)                    |	[font-optical-sizing](https://developer.mozilla.org/en-US/docs/Web/CSS/font-optical-sizing) |
| [tempo-transicao](https://github.com/DesignLiquido/FolEs/wiki/Modificador-tempo-transi%C3%A7%C3%A3o)                         |	[transition-timing-function](https://developer.mozilla.org/pt-BR/docs/Web/CSS/transition-timing-function) |
| [tempo-transição](https://github.com/DesignLiquido/FolEs/wiki/Modificador-tempo-transi%C3%A7%C3%A3o)                         |	[transition-timing-function](https://developer.mozilla.org/pt-BR/docs/Web/CSS/transition-timing-function) |
| [texto-bidirecional](https://github.com/DesignLiquido/FolEs/wiki/Modificador-texto-bidirecional)                      |	[unicode-bidi](https://developer.mozilla.org/en-US/docs/Web/CSS/unicode-bidi) |
| [tipo-encaixe-rolagem-mouse](https://github.com/DesignLiquido/FolEs/wiki/Modificador-tipo-encaixe-rolagem-mouse)              |	[scroll-snap-type](https://developer.mozilla.org/en-US/docs/Web/CSS/scroll-snap-type) |
| [tipo-mascara](https://github.com/DesignLiquido/FolEs/wiki/Modificador-tipo-m%C3%A1scara)                            |	[mask-type](https://developer.mozilla.org/en-US/docs/Web/CSS/mask-type) |
| [tipo-máscara](https://github.com/DesignLiquido/FolEs/wiki/Modificador-tipo-m%C3%A1scara)                            |	[mask-type](https://developer.mozilla.org/en-US/docs/Web/CSS/mask-type) |
| [toque-tela](https://github.com/DesignLiquido/FolEs/wiki/Modificador-toque-tela)                              |	[touch-action](https://developer.mozilla.org/pt-BR/docs/Web/CSS/touch-action) |
| [trajeto-deslocamento](https://github.com/DesignLiquido/FolEs/wiki/Modificador-trajeto%E2%80%90deslocamento)                    |	[offset-path](https://developer.mozilla.org/en-US/docs/Web/CSS/offset-path) |
| [transformar](https://github.com/DesignLiquido/FolEs/wiki/Modificador-transformar)                             |	[transform](https://developer.mozilla.org/pt-BR/docs/Web/CSS/transform) |
| [transformar-caixa](https://github.com/DesignLiquido/FolEs/wiki/Modificador-transformar-caixa)                       |	[transform-box](https://developer.mozilla.org/en-US/docs/Web/CSS/transform-box) |
| [transformar-estilo](https://github.com/DesignLiquido/FolEs/wiki/Modificador-transformar-estilo)                      |	[transform-style](https://developer.mozilla.org/en-US/docs/Web/CSS/transform-style) |
| [transformar-origem](https://github.com/DesignLiquido/FolEs/wiki/Modificador-transformar-origem)                      |	[transform-origin](https://developer.mozilla.org/en-US/docs/Web/CSS/transform-origin) |
| [transformar-texto](https://github.com/DesignLiquido/FolEs/wiki/Modificador-transformar-texto)                       |	[text-transform](https://developer.mozilla.org/pt-BR/docs/Web/CSS/text-transform) |
| [transicao](https://github.com/DesignLiquido/FolEs/wiki/Modificador-transi%C3%A7%C3%A3o)                               |	[transition](https://developer.mozilla.org/pt-BR/docs/Web/CSS/transition) |
| [transição](https://github.com/DesignLiquido/FolEs/wiki/Modificador-transi%C3%A7%C3%A3o)                               |	[transition](https://developer.mozilla.org/pt-BR/docs/Web/CSS/transition) |
| [variacao-fonte](https://github.com/DesignLiquido/FolEs/wiki/Modificador-varia%C3%A7%C3%A3o-fonte)                          |	[font-variant](https://developer.mozilla.org/en-US/docs/Web/CSS/font-variant) |
| [variação-fonte](https://github.com/DesignLiquido/FolEs/wiki/Modificador-varia%C3%A7%C3%A3o-fonte)                          |	[font-variant](https://developer.mozilla.org/en-US/docs/Web/CSS/font-variant) |
| [variacao-fonte-alternativa](https://github.com/DesignLiquido/FolEs/wiki/Modificador-varia%C3%A7%C3%A3o-fonte-alternativa)              |	[font-variant-alternates](https://developer.mozilla.org/en-US/docs/Web/CSS/font-variant-alternates) |
| [variação-fonte-alternativa](https://github.com/DesignLiquido/FolEs/wiki/Modificador-varia%C3%A7%C3%A3o-fonte-alternativa)              |	[font-variant-alternates](https://developer.mozilla.org/en-US/docs/Web/CSS/font-variant-alternates) |
| [variacao-fonte-asiatica](https://github.com/DesignLiquido/FolEs/wiki/Modificador-varia%C3%A7%C3%A3o-fonte-asi%C3%A1tica)                 |	[font-variant-east-asian](https://developer.mozilla.org/en-US/docs/Web/CSS/font-variant-asian) |
| [variação-fonte-asiática](https://github.com/DesignLiquido/FolEs/wiki/Modificador-varia%C3%A7%C3%A3o-fonte-asi%C3%A1tica)                 |	[font-variant-east-asian](https://developer.mozilla.org/en-US/docs/Web/CSS/font-variant-asian) |
| [variacao-fonte-ligacao](https://github.com/DesignLiquido/FolEs/wiki/Modificador-varia%C3%A7%C3%A3o-fonte-liga%C3%A7%C3%A3o)                  |	[font-variant-ligatures](https://developer.mozilla.org/en-US/docs/Web/CSS/font-variant-ligatures) |
| [variação-fonte-ligação](https://github.com/DesignLiquido/FolEs/wiki/Modificador-varia%C3%A7%C3%A3o-fonte-liga%C3%A7%C3%A3o)                  |	[font-variant-ligatures](https://developer.mozilla.org/en-US/docs/Web/CSS/font-variant-ligatures) |
| [variacao-fonte-maiuscula](https://github.com/DesignLiquido/FolEs/wiki/Modificador-varia%C3%A7%C3%A3o-fonte-mai%C3%BAscula)                |	[font-variant-caps](https://developer.mozilla.org/en-US/docs/Web/CSS/font-variant-caps) |
| [variação-fonte-maiúscula](https://github.com/DesignLiquido/FolEs/wiki/Modificador-varia%C3%A7%C3%A3o-fonte-mai%C3%BAscula)                |	[font-variant-caps](https://developer.mozilla.org/en-US/docs/Web/CSS/font-variant-caps) |
| [variacao-fonte-numerica](https://github.com/DesignLiquido/FolEs/wiki/Modificador-varia%C3%A7%C3%A3o-fonte-num%C3%A9rica)                 |	[font-variant-numeric](https://developer.mozilla.org/en-US/docs/Web/CSS/font-variant-numeric) |
| [variação-fonte-numérica](https://github.com/DesignLiquido/FolEs/wiki/Modificador-varia%C3%A7%C3%A3o-fonte-num%C3%A9rica)                 |	[font-variant-numeric](https://developer.mozilla.org/en-US/docs/Web/CSS/font-variant-numeric) |
| [variacao-fonte-posicao](https://github.com/DesignLiquido/FolEs/wiki/Modificador-varia%C3%A7%C3%A3o-fonte-posi%C3%A7%C3%A3o)                  |	[font-variant-position](https://developer.mozilla.org/en-US/docs/Web/CSS/font-variant-position) |
| [variação-fonte-posição](https://github.com/DesignLiquido/FolEs/wiki/Modificador-varia%C3%A7%C3%A3o-fonte-posi%C3%A7%C3%A3o)                  |	[font-variant-position](https://developer.mozilla.org/en-US/docs/Web/CSS/font-variant-position) |
| [vazamento](https://github.com/DesignLiquido/FolEs/wiki/Modificador-vazamento)                               |	[overflow](https://developer.mozilla.org/pt-BR/docs/Web/CSS/overflow) |
| [vazamento-em-ancora](https://github.com/DesignLiquido/FolEs/wiki/Modificador-vazamento-em-%C3%A2ncora)                     |	[overflow-anchor](https://developer.mozilla.org/en-US/docs/Web/CSS/overflow-anchor) |
| [vazamento-em-âncora](https://github.com/DesignLiquido/FolEs/wiki/Modificador-vazamento-em-%C3%A2ncora)                     |	[overflow-anchor](https://developer.mozilla.org/en-US/docs/Web/CSS/overflow-anchor) |
| [vazamento-em-bloco](https://github.com/DesignLiquido/FolEs/wiki/Modificador-vazamento-em-bloco)                      |	[overflow-block](https://developer.mozilla.org/en-US/docs/Web/CSS/overflow-block) |
| [vazamento-em-linha](https://github.com/DesignLiquido/FolEs/wiki/Modificador-vazamento-em-linha)                      |	[overflow-inline](https://developer.mozilla.org/en-US/docs/Web/CSS/overflow-inline) |
| [vazamento-horizontal](https://github.com/DesignLiquido/FolEs/wiki/Modificador-vazamento-horizontal)                    |	[overflow-x](https://developer.mozilla.org/en-US/docs/Web/CSS/overflow-x) |
| [vazamento-texto](https://github.com/DesignLiquido/FolEs/wiki/Modificador-vazamento-texto)                         |	[text-overflow](https://developer.mozilla.org/pt-BR/docs/Web/CSS/text-overflow) |
| [vazamento-vertical](https://github.com/DesignLiquido/FolEs/wiki/Modificador-vazamento-vertical)                      |	[overflow-y](https://developer.mozilla.org/en-US/docs/Web/CSS/overflow-y) |
| [velocidade-animacao](https://github.com/DesignLiquido/FolEs/wiki/Modificador-velocidade-anima%C3%A7%C3%A3o)                     | [animation-timing-function](https://developer.mozilla.org/en-US/docs/Web/CSS/animation-timing-function) |
| [velocidade-animação](https://github.com/DesignLiquido/FolEs/wiki/Modificador-velocidade-anima%C3%A7%C3%A3o)                     | [animation-timing-function](https://developer.mozilla.org/en-US/docs/Web/CSS/animation-timing-function) |
| [visibilidade](https://github.com/DesignLiquido/FolEs/wiki/Modificador-visibilidade)                            |	[visibility](https://developer.mozilla.org/pt-BR/docs/Web/CSS/visibility) |
