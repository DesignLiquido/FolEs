...
| [fim-coluna-em-grade](https://github.com/DesignLiquido/FolEs/wiki/Modificador-fim-coluna-em-grade)                     | [grid-column-end]([url](https://developer.mozilla.org/en-US/docs/Web/CSS/grid-column-end)) |
